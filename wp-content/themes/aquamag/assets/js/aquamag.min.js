...
function(a, b) {
    ...
    var c = function(b, d) {
        var e = this,
            f = a(b);
        f.data("buttonRadio") || (this.options = a.extend({}, c.defaults, d), this.element = f.on("hover", this.options.target, function(b) {
    ...
    var d = function(b, c) {
        var e = a(b);
        e.data("buttonCheckbox") || (this.options = a.extend({}, d.defaults, c), this.element = e.on("hover", this.options.target, function(b) {
    ...
    var e = function(b, c) {
        var d = this,
            f = a(b);
        f.data("button") || (this.options = a.extend({}, e.defaults, c), this.element = f.on("hover", function(a) {
...
function(a, b, c) {
    ...
    a.extend(g.prototype, {
        ...
        show: function() {
            return this.isActive() ? void 0 : (e && e.hide(!0), this.element.removeClass("uk-open").show(), this.resize(), e = this, f.addClass("uk-modal-page").height(), this.element.addClass("uk-open").trigger("uk.modal.show"), this)
        },
        hide: function(a) {
            if (this.isActive()) {
...
function(a, b) {
    ...
    g.offcanvas = f, b.offcanvas = g, e.on("click.offcanvas.uikit", "[data-uk-offcanvas]", function(c) {
        c.preventDefault();
        var d = a(this);
        d.data("offcanvas") || (new g(d, b.Utils.options(d.attr("data-uk-offcanvas"))), d.trigger("click"))
    })
}(jQuery, jQuery.UIkit),
function(a, b) {
    "use strict";
...
function(a, b) {
    ...
    var c = function(b, d) {
        var e = this,
            f = a(b);
        if (!f.data("switcher")) {
            if (this.options = a.extend({}, c.defaults, d), this.element = f.on("hover", this.options.toggle, function(a) {
    ...
    var c = function(b, d) {
        ...
        if (!f.data("tab")) {
            ...
            i.html(this.element.find("li.uk-active:first").find("a").text()), this.element.hasClass("uk-tab-bottom") && j.addClass("uk-dropdown-up"), this.element.hasClass("uk-tab-flip") && j.addClass("uk-dropdown-flip"), this.element.find("a").each(function(b) {
                var c = a(this).parent(),
                    d = a('<li><a href="javascript:void(0);">' + c.text() + "</a></li>").on("hover", function() {
...
function(a, b) {
    ...
    c.defaults = {
        ...
        var d = a(this);
        d.data("smoothScroll") || (new c(d, b.Utils.options(d.attr("data-uk-smooth-scroll"))), d.trigger("click"))
    })
}(jQuery, jQuery.UIkit),
function(a, b, c) {
    var d = function(a, c) {
...
$(document).ready(function() {
    $(".hentry, .widget").fitVids(), $("ul.sf-menu").superfish({
        delay: 100,
        speed: "fast",
        autoArrows: !1
    })
